...
namespace GameSpace
{
    public class Game
    {
       ...
       private Vector2f posicaoscore = new Vector2f(); 
       ...
       private void eventosTeclado()
       {
           // Direção da nave
            ...
            // Fim de jogo
            if (Keyboard.IsKeyPressed(Keyboard.Key.Escape)){this.window.Close();}
            
            if (this.lstinimigo.Count <= 0) {this.window.Close();}
       }
       ...
       private void desenhar()
       {
            ...
            textContent.Position = posicaoscore;
